def englishNumber number
  ...
  left  = number            #left = 265
  write = left/100          # How many hundreds left to write out? e.g write = 265/100 = 2
  left  = left - write*100  # Subtract off those hundreds. left = 265 - 200
