...
# No more special cases! No more returns!
    num_string = '' # This is the string we will return. ones_place = ['one', 'two', 'three',
                'four',      'five',     'six',
                'seven',     'eight',    'nine']
...
left = number
while zillions.length > 0 zil_pair = zillions.pop zil_name = zil_pair[0] zil_base = 10 ** zil_pair[1] write = left/zil_base
...
if left > 0
# So we don't write 'two billionfifty-one'... num_string = num_string + ' '
end end
end
