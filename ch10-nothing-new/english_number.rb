...
left = number
write = left/1000000000000 # How many trillionss left?
...
if left > 0
# So we don't write 'two trillionfive thousand'...
num_string = num_string + ' '
end
end
write = left/1000000000 # How many billionss left?
...
if left > 0
# So we don't write 'two billionfive thousand'...
num_string = num_string + ' '
end
end
write = left/1000000 # How many millionss left?
...
if left > 0
# So we don't write 'two millionfive thousand'...
num_string = num_string + ' '
end
end
