puts "Please enter the number of bottles:"
...
puts "#{english_number(number-1)} bottle of beer on the wall, #{english_number(number-1)} bottle of beer.
Take one down and pass it around, no more bottles of beer on the wall."

puts "No more bottles of beer on the wall, no more bottles of beer.
Go to the store and buy some more, #{english_number(old_number)} bottles of beer on the wall."
