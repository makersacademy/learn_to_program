...
while number > 2 
  ...
  Take one down, pass it around, that's " + english_number(number-1) + " bottles of beer on the wall.
...
if number == 2
	puts english_number(number) + " bottles of beer on the wall, " + english_number(number) + " bottles of beer! 
  Take one down, pass it around, that's " + english_number(number-1) + " bottle of beer on the wall.

  "
  number -= 1
end
if number == 1
  print "#{english_number(number)} bottle of beer on the wall, #{english_number(number)} bottle of beer.
