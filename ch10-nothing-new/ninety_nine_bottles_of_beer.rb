...
def ninety_nine_bottles (num)
  if num == 0
    puts "no beer"
while num > 1
  puts english_number(num).capitalize + "bottles of beer on the wall" + english_number(num) +" bottles of beer! Take one down, pass it around, "
  num -= 1
  print english_number(num)+ "bottles of beer on the wall."
end
puts "One bottle of beer on the wall, one bottle of beer! Take it down, pass it around, no more bottles of beer on the wall!"
