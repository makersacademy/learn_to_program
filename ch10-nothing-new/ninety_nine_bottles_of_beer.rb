...
loop do
  ...
  n-=1
  puts "Take one down and pass it around, #{english_number (n)} bottles of beer on the wall."
  elsif n==1
  puts "#{english_number (n)} bottle of beer on the wall, #{english_number (n)} bottle of beer."
  n-=1
