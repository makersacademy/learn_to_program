...
while true
  puts "#{english_number(bottle).capitalize} bottles of beers on the wall, #{english_number(bottle)} bottles of beer."
  puts "take one down, and pass it around, #{english_number(bottle-1)} bottles of beer on the wall."
  bottle = bottle - 1
    if bottle == 1
      puts "#{english_number(bottle).capitalize} more bottle of beer on the wall, #{english_number(bottle)} more bottle of beer."
