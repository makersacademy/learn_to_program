...
def bottles number
  ...
  while bottles_left > 2
    puts english_number(bottles_left) + " bottles of beer on the wall, " + english_number(bottles_left)+ " bottles of beer!"
    puts "Take one down, pass it around " + english_number(bottles_left - 1).to_s + " bottles of beer on the wall!"
    bottles_left -= 1
  end
