def english_number number
    ...
    zillions = [['hundred', 2],['thousand', 3],['million', 6],['billion',9],['trillion',12],['quadrillion',15],['quintillion',18],
                ...
                ['septendecillion', 54],['octodecillion', 57],['novemdecillion', 60],['vigintillion', 63],['googol', 1001]]
...
bottle -= 1
puts "Take one down and pass it around, " + english_number(bottle) + " bottles of beer on the wall."
end

puts english_number(bottle).capitalize + " bottles of beer on the wall, " + english_number(bottle) + " bottles of beer."
bottle -= 1
puts "Take one down and pass it around, " + english_number(bottle) + " bottle of beer on the wall."

puts english_number(bottle).capitalize + " bottle of beer on the wall, " + english_number(bottle) + " bottle of beer."
bottle -= 1
puts "Take one down and pass it around, " + english_number(bottle) + " bottles of beer on the wall."
