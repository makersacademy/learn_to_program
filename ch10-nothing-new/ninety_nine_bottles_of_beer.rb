...
bottles_left = number_of_bottles
...
while bottles_left > 0
  ...
  puts "#{english_number(bottles_left).capitalize} #{bottles_left == 1 ? "bottle" : "bottles"} of beer on the wall!"
  puts ""
end
...
puts "#{english_number(bottles_left).capitalize} bottles of beer!"
bottles_left = number_of_bottles
puts "Go to the store, buy #{english_number(bottles_left)} more,"
puts "#{english_number(bottles_left).capitalize} #{bottles_left == 1 ? "bottle" : "bottles"} of beer on the wall!"
