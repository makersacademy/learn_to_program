...
while bottles_of_beer > 0
  puts english_number(bottles_of_beer).capitalize + ' bottles of beer on the wall ' + english_number(bottles_of_beer) + ' bottles of beer! You take one down and pass it around ' + english_number(bottles_of_beer-1) + ' bottles of beer on the wall!'
