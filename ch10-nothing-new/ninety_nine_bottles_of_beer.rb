...
def englishNumber number
  ...
  left  = number
      #quadrillion!--------------------------------------------------
    write = left/1000000000000000 # How many quadrillions left to write out?
  ...
  if write > 0
    ...
    if left > 0
      # So we don't write 'one quadrilliontwo billion'...
      numString = numString + ' '
    end
  end
  ...
  if write > 0
    ...
    if left > 0
      # So we don't write 'one trilliontwo hundred million'...
      numString = numString + ' '
    end
  end
  ...
  if write > 0
    ...
    if left > 0
      # So we don't write 'milliontwo hundred thousand'...
      numString = numString + ' '
    end
  end
  ...
  left = left - write*1000 # subtract of those thousands.
...
while number != 0
  num_bottles = englishNumber(number)
  puts "#{num_bottles.capitalize} bottles of beer on the wall, #{num_bottles.capitalize} bottles of beer."
  puts ''
  number -= 1
  if number == 0
    ...
    puts "Take one down and pass it around, #{num_bottles.capitalize} bottles of beer on the wall."
    puts ''
  end
end
