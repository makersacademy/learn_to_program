...
bottlesleft = (1..beers).to_a

while bottlesleft.length > 0
bottlenumber = bottlesleft.pop
puts  "#{english_number(bottlenumber).capitalize} bottle#{bottlenumber==1 ? "" : "s"} of beer on the wall,"
puts  "#{english_number(bottlenumber).capitalize} bottle#{bottlenumber==1 ? "" : "s"} of beer,"
puts  "Take one down, pass it around,"
puts  "#{english_number(bottlenumber-1).capitalize} bottle#{bottlenumber-1==1 ? "" : "s"} of beer on the wall.\n"
    puts ""

end
    puts "Zero bottle#{bottlenumber==1 ? "" : "s"} of beer on the wall."
