...
def ninetynine_bottles number
  while number > 0
    written_number = english_number number
    puts written_number.capitalize + ' bottles of beer on the wall, ' + written_number + ' bottles of beer.'
    number = number -1
    puts 'Take one down, pass it around, ' + written_number + ' bottles of beer on the wall...'
  end
end

ninetynine_bottles 9
