...
while num_now > 1
  puts english_num(num_now).capitalize + ' bottles of beer on the wall, ' + english_num(num_now) + ' bottles of beer!'
  num_now = num_now - 1
  puts 'Take one down, pass it around, ' + english_num(num_now) + ' bottles of beer on the wall!'
end
