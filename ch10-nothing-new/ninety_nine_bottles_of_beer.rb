...
def bottles_of_beer(number)
  while number >0
    beer = english_number(number)
    next_beer = english_number(number-1)

    if number > 2
      puts "#{beer.capitalize} bottles of beer on the wall, #{beer} bottles of beer."
      puts "Take one down and pass it around, #{next_beer} bottles of beer on the wall."
    elsif  number == 2
      puts "#{beer.capitalize} bottles of beer on the wall, #{beer} bottles of beer."
      puts "Take one down and pass it around, #{next_beer} bottle of beer on the wall."
    elsif  number == 1
      puts "#{beer.capitalize} bottles of beer on the wall, #{beer} bottles of beer."
