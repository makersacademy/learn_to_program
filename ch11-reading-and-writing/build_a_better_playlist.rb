...
#    evens, odds = a.partition.with_index{ |_, i| i.even? }
#    shuffled = odds + evens
#    once = shuffled.take(b/2) + shuffled.drop(b/2) 
#    evens1, odds1 = once.partition.with_index{ |_, i| i.even? }
#    shuffled_again =  evens1 + odds1
#    shuffled_again.drop(b/2) + shuffled_again.take(b/2)
# end
