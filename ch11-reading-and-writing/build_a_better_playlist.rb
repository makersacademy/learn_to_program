# struggled with this for over an hour - part of the problem was not
# grasping what format the "filenames" would come in, or the number
# of subdirectories - I will walk myself through the code a couple more times
# but for now, pine's solution is pasted below.
