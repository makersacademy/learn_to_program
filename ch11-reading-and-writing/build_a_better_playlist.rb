...
#def music_shuffle filenames
  ...
  #filenames.sort
  #playlist_length = filenames.size 
  #shuffled = []
  #selected_order = []

  #while selected_order.size < playlist_length

	#shuffled = shuffled << filenames.select.each_with_index { |x, i| i.odd? } << filenames.select.each_with_index { |x, i| i.even? }

	#selected_order = selected_order << shuffled.flatten![rand(playlist_length)]
...
#PINE'S SOLUTION BECAUSE THE SPEC SUCKS
