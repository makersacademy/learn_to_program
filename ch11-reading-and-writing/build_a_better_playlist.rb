...
# There is no way to solve this without reading the solution.
# I understand why working through the spec is a valid way to solve the problem.
# I don't understand why having to read the solution is helpful.
