Dir.chdir '/Users/towilkins/Pictures'

# First we find all of the pictures to be moved.

pic_names = Dir['/Users/towilkins/Pictures to move/**/*.jpg']
...
if File.exist? "#{batch_name}0#{pic_number}.jpg" 
	puts "Error - there is a file existing in the directory with that name - Exiting"
	exit
else
