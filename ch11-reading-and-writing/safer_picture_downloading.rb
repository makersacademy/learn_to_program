...
pic_names = Dir['F:/**/*.jpg']
#want to check if they exist already in pictureinbox using the code below (think it works but not sure)
pic_names.each do |name|
  File.exist? (name)
  if return true
   puts "#{name} file exist already"
   break
  else
   next
end
#to keep it separate from other code
