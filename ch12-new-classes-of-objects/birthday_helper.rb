# Again using Pine's solution because I spent too long on this - though I can't # believe I did after seeing this code. Nice use of ranges.
...
File.read('birthdates.txt').each_line do |line|
  ...
  date = line[-12..-1] # I particularly like this
