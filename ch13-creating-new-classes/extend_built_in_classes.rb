class Integer
	...
	nums = {'M'=>1000, 'CM'=>900, 'D'=>500, 'CD'=>400, 'C'=>100, 'XC'=>90, 'L'=>50, 'XL'=>40, 'X' => 10, 'IX' => 9, 'V' => 5, 'IV' => 4, 'I' => 1 } #a hash of the building blocks
	n = self
	...
	nums.each { |i,j| #iterate through nums hash (where i is key, j is value)
		...
		n = r #redefine n - what was pushed already for next iteratio
	}
