...
class Integer                 # Integer class, because that is what the 'self' should be.
  def factorial               # Here we define the name of the .method
    if self <= 1
      1
    else
  ...
  # Here is another .method we are adding to the Integer class.
  def to_roman
