...
dragon = 'alive'
puts "Do something with your baby dragon. [Type 'help' for a list of options.]"

while dragon == 'alive' do
  print '> '
  ...
  when command == 'help'
    puts 'Instructions: '
    puts 'Feed / Toss / Walk / Put to bed / Rock'
  else
    puts 'That isn\'t really something your dragon likes...'
  end
end