...
puts "What would you like name the dragon?"
name = gets.chomp
pet = Dragon.new name
puts "#{name} is born"
...
puts "these are the commands you can give: feed walk put_to_bed toss rock"
answer = gets.chomp

case answer
when 'feed' then pet.feed
when 'walk' then pet.walk
when 'put_to_bed' then pet.put_to_bed
when 'toss' then pet.toss
when 'rock' then rock
when 'exit' then exit
else puts "please enter one of the commands or exit"
end
