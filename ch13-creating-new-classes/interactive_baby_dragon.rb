...
#####
#code above is the baby dragon class from the book
#prompt user for a name for the dragon
puts 'Choose a name for your baby dragon'
#store name
name = gets.chomp
#create instance of Dragon with the users dragon name
baby_dragon = Dragon.new name
#opens a loop that stays open until the user enters the exit command
while true
  #make sure newline
  puts
  ...
  command = gets.chomp
  #checks the command via elsif's
  if command == 'exit'
    exit
  elsif command == 'feed'
    baby_dragon.feed
