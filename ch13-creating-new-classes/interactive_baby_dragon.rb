...
loop do
  print "\nThe following commands are available for your dragon: feed, toss, " +
  "put to bed, rock, walk\n"
  print "What do you want to do with your dragon (use exit to quit)?"
  prompt = gets.chomp.downcase #prompt user to add a command
  puts
  case prompt
  ...
  when "exit" then break
    ...
    print "Command does not exist, please use a proper one.\n"
  end
end
