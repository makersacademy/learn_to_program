...
def passage_of_time
  if @stuff_in_belly > 0
    #Move stuff from belly to intestine
...
def interactive_dragon
  ...
  name = gets.chomp # asks for the name to create a new Dragon
  pet = Dragon.new(name)

while true # this is the start of the loop
  puts "What would you like to do? \n Type in one of the following commands: \n'Feed', 'Walk', 'Put to bed', 'Toss' or 'Rock'"
  command = gets.chomp.downcase

case command # this is a quicker way of going through all options and giving commands
