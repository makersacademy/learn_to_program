# your code hereif @stuff_in_intestine >= 10
class Dragon
  def initialize name
    @name = name
    @asleep = false
...
while true
  puts
  puts 'Please type one of the following commands: feed, toss, walk, rock, put_to_bed, exit'
  command = gets.chomp
  if command == 'exit'
    exit
    ...
    puts "As a reminder, you need to type one of the following commands: feed, toss, walk, rock, put_to_bed, exit"
  end
end
