...
puts "what would you like to call the Dragon?"
name = gets.chomp
dragon = Dragon.new name
puts dragon
while true
  puts "what method would you like to run on the #{name}: feed, toss, walk, rock, put_to_bed or exit"
