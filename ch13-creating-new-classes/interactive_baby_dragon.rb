...
# dragon, but you can't ask him whether he's hungry.)
	...
	def hungry? # Method names ends with ? as returning either true or false
		@stuff_in_belly <= 2
	end
...
arr= ["feed","toss","walk","put_to_bed"]

while true
puts "What do you want to do with your baby dragon?\nYou can either:\nfeed, toss, walk, put_to_bed or to exit, type exit."
command = gets.chomp
	if command == "exit"
		exit
	elsif arr.include?(command)
		dragon.send command
	else 
